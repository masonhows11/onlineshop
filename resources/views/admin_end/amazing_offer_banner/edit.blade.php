    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-start my-4 bg-white">
            <div class="col-lg-4 col-md-4 col  my-5  border-bottom title-add-to-stock">
                <div class="alert my-4">
                    <h3>{{ __('messages.amazing_offer_banner') }} / {{ __('messages.edit_banner') }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row my-4 bg-white">
            <div class="col-lg-4 col-md-4 col my-2">
                <a href="{{ route('admin.amazing.banner.index') }}"
                   class="btn btn-sm btn-primary">{{ __('messages.list_banners') }}</a>
            </div>
        </div>


        <form action="{{ route('admin.amazing.banner.update') }}" method="post" enctype="multipart/form-data">
            @csrf

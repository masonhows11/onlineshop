    ...
    <div class="container-fluid">
        ...
        <div class="row my-4 bg-white">
            <div class="col-lg-4 col-md-4 col my-2">
                <a href="{{ route('admin.top.banner.create') }}"
                   class="btn btn-sm btn-primary">{{ __('messages.new_banner') }}</a>
            </div>
        </div>
                ...
                @foreach( $banners as $banner)
                    <div class="card border border-2 border-secondary mb-2">
                        <img   src="{{ $banner->image_path ? ($banner->image_path) : asset('dash/images/no-image-icon-23494.png') }}"
                                class="card-img-top" height="100" alt="banner-image">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <p class="card-text">
                                        ...
                                        <a href="{{ route('admin.top.banner.edit',$banner->id) }}"
